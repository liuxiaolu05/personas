...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                // 需要保存的字段
                // saveFields: ["catPrefer", "catName", "brandPrefer", "brandName", "crowdId", "dateRange","beginTime","endTime","regionCode","firstBranch","secondBranch","store","crowdName","channel","frequency","frequencyCount","coverUser","createUser"],
                saveFields: ["catPrefer", "catName", "brandPrefer", "brandName"],
                // 计算覆盖人数需要的字段
                calFields: ["scenesType", "catPrefer", "brandPrefer", "regionCode", "firstBranch", "secondBranch", "store"],
                calValidateFields: ["catPrefer"],
                ifShowProduct: 1,
                editData: {
                    scenesType: "1",
                    catPrefer: null, // 品类id
                    catName: null,//品类名称
                    brandPrefer: null, // 品牌id
                    brandName: null // 品牌名称
                }
            }
        }
